...
**
**/
const generateEventId = function ( methodName ) {
...
**
**/
const catchEventFabric = function ( map, eventName, eventId, resolve ) {
...
**
**/
export default function promisifyMethod ( map, methodName ) {
